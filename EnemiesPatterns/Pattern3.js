...
class Enemy {
    constructor(){
        ...
        this.image.src = 'EnemiesImage/enemy3.png';
...
update(){
    // Hay muchos patrones que podemos sacar con esta formula, cambiando cos, sin, las diviciones de PI, el canvas.width y height.
